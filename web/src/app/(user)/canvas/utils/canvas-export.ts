...
export async function exportCanvasProjects(projects: CanvasProject[], fileName = "bytebroad-canvas") {
    ...
    const data: CanvasExportFile = { app: "bytebroad-canvas", version: 3, exportedAt: new Date().toISOString(), projects: exportedProjects };
